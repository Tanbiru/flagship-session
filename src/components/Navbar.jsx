...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <li>
        <NavLink className={({isActive}) => isActive? 'text-indigo-600' : ''} to='/cart'><FaShoppingCart size={20} /></NavLink>
      </li>
      <li>
        <NavLink className={({isActive}) => isActive? 'text-indigo-600' : ''} to='/favourites'><MdBookmarkAdd size={20}/></NavLink>
      </li>
      </ul>
    </div>
